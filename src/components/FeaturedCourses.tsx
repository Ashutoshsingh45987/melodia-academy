  ...
  <div className="py-12 bg-gray-900 ">
    <div>
        <div className=" text-center">
            <h2 className=" text-base text-teal-600 font font-semibold tracking-wide uppercase">Featured Courses</h2>
...
export default FeaturedCoursed;
